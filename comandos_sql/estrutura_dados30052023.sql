...
2	produto	50.00	25.00	35
6	New pro 	20.00	10.00	39
5	Provavelmente 	30.00	15.00	34
7	Novoro 	50.00	30.00	28
4	Chave 	20.00	10.00	16
1	pro1	10.50	5.50	11
\.
...
COPY public.venda (codvenda, cliente_codcli, data_venda, data_hora, total) FROM stdin;
91	7	2023-05-30	2023-05-30 13:22:22.461718	100.00
92	3	2023-05-30	2023-05-30 13:24:57.799876	150.00
\.
...
SELECT pg_catalog.setval('public.venda_codvenda_seq', 92, true);
